...
export const crecy1346Deployments: UnitDeployment[] = [
  ...
  { id: "fra-crossbow-1", sideId: "france", unitTypeId: "genoese-crossbowmen", position: { q: 3, r: 6 } },
  { id: "fra-crossbow-2", sideId: "france", unitTypeId: "genoese-crossbowmen", position: { q: 8, r: 6 } },
  { id: "fra-knights-1", sideId: "france", unitTypeId: "french-knights", position: { q: 2, r: 8 }, commanderId: "philip-vi" },
  { id: "fra-knights-2", sideId: "france", unitTypeId: "french-knights", position: { q: 9, r: 8 } },
